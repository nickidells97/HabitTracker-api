...
INSERT INTO habits (unique_event_id, title, body, start_date, end_date, start_time, end_time, user_id, completed)
  VALUES
  ("running20230309", "Running", "I want to run 3 times per week", "2023-03-09", "2023-03-28", "7:00", "8:00", 2, false),
  ("coding20230309", "Coding",  " Practicing everyday to be a great developer", "2023-03-09", "2023-03-28", "18:00", "22:00", 1, false ),
  ("coding20230319", "Coding",  " Practicing everyday to be a great developer", "2023-03-09", "2023-03-28", "23:00", "24:00", 3, false );